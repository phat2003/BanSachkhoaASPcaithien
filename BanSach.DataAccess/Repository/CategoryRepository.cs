...
{
    public class CategoryRepository : Repository<Category>, ICategoryRepository //thừa kế từ lớp Repository<Category> và triển khai giao diện ICategoryRepository.
    {
