    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //((ApplicationUser)user).Name = Input.Name;
                //((ApplicationUser)user).StreetAddress = Input.StreetAddress;
                //((ApplicationUser)user).City = Input.City;
                //((ApplicationUser)user).State = Input.State;
                //((ApplicationUser)user).PostalCode = Input.PostalCode;
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, SD.Role_User_Indi);//default role
                    }
